...
wine_attribute <- function(attribute, histLabel = '') {
...
wine_attribute(wines$alcohol, histLabel = 'Alcohol (% of vol)')
```
...
information is to correlate the wine density with the water density of the 
watersheds from the production region.  
